...
import { friendlyName, presenceLabel, sectionTitle, entityArea, iconFor, isActive, isUnavailable,
  ...
  doorEntityIds, lastEventTime, recentDoorIds,
...
import { apiCall, fetchHistory, fetchRegistry, fetchHAConfig } from './api.js';
import { connect } from './connection.js';
import { renderCameraFeed, startLivestreamCameras, stopLivestreamCameras, refreshCameraSnapshot,
  snapshotLastActivityMs, SNAPSHOT_IDLE_EVENT_WINDOW_MS, SNAPSHOT_IDLE_POLL_MS, SNAPSHOT_CHECK_MS } from './cameras.js';
import { renderRadarFrame, initRadarMap } from './radar.js';
import { renderTerminalPanel, renderStatusLed, renderAlertBanner, renderSceneButton } from './components/panels.js';
import { renderLightCard, renderSwitchCard, renderMetricCard, renderSparkline, renderEnvMetric, renderMediaCard } from './components/cards.js';
